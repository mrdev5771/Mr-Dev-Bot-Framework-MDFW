module.exports.config = {
  name: "warv6",
  version: "1.0.6", // Updated for more brutal diss mode lyrics
  hasPermssion: 0,
  credits: "MrDeveloper & Grok & ChatGPT",
  usePrefix: true,
  description:
    "Advanced rap-battle generator — multisyllabic rhyme chains, internal rhyme, double/triple entendres, 5 styles (eminem/royce/lupe/jcole/diss). Usage: warv5 [@user|random] [style] [maxLines] [delayMs]",
  commandCategory: "group",
  usages:
    "warv5 [optional: @username | random] [optional: style] [optional: maxLines] [optional: delayMs]",
  cooldowns: 5,
  dependencies: {},
};
...
const seedBank = {
  eminem: [
    ...
    // New verse inspired by "Killshot" and "The Ringer": personal attacks, mumble rap disses, multisyllabic
    [
      "{target}, you sound like a whiner, designer but minor — I'm the refiner, signer of the liner,",
      "Killshot precision, incision decision — vision collision, I mission the fission,",
      "Your beard's weird, feared but sneered — I sheared the cleared, appeared the reared,",
      "Internal venom: stem from the gem, hem your condemn — I condemn your stem,",
      "Double entendre loaded: 'ringer' your bell and your fall — I call the stall, install the wall,",
      "You mumble and jumble, stumble in humble — I crumble the tumble, fumble the rumble,",
      "Triple threat tucked: 'axe' your track, your hack, your lack — I pack the stack,",
      "Chain devastation: elevation in station — I station your nation in degradation,",
      "Your fans turn haters, waiters for craters — I cater the traitors, rate the debaters,",
      "I orchestrate the hate, dictate the rate — late to the gate, I ate your plate,",
      "Punchline payload: explode your abode, reload the code — I mode the overload,",
      "I’m the rap revival, survival of the fittest — witness the fitness, dismiss the misfit,",
      "{target}, your era's error, terror in the mirror — clearer the nearer, I steer the queerer,",
      "Final fatality: brutality in duality — actuality your fallacy, I rally the tally,",
      "I leave you rung and hung, tongue in the rung — sung the flung, I lung the dung.",
      "{target}, bow or be rung — sung in the lung, stung by the one.",
    ],
    // New verse inspired by "Not Alike" and "Fall": dissing styles, personal jabs
    [
      "{target}, we are not alike, spike in the mic — hike the like, strike the bike,",
      "Your molotov's mild, child in the wild — I piled the tiled, smiled the filed,",
      "Internal explosion: erosion of notion, commotion in ocean — I potion the devotion,",
      "Double meaning menace: 'fall' your grace and your place — I race the pace, face the case,",
      "You addict to static, attic fanatic — I tactic the dramatic, automatic the erratic,",
      "Triple entendre tucked: 'marathon' your pace, your chase, your waste — I taste the haste,",
      "Chain the pain parade: fade in the shade, blade the grade — I raid the made,",
      "Your boss pops pills, skills in the bills — I fills the thrills, kills the ills,",
      "I concentrate against the clock, rock the stock — lock the mock, shock the flock,",
      "Punchline payload: explode the code, reload the mode — overload the road,",
      "I’m the echo of eminence, imminence in prominence — {target}, your dominance is somnolence,",
      "{target}, you create nothing, bluffing in stuffing — I cuffing the puffing,",
      "Final swing savage: ravage the average, savage the baggage — I manage the damage,",
      "I leave you fallen and callin', stallin' in maulin' — haulin' the appallin',",
      "Your pace is erased, faced with the waste — I paste the haste, taste the baste.",
      "{target}, fall off the wall — call in the stall, I'm the all in your brawl.",
    ],
    // New verse inspired by "Bully" and general disses: aggressive repetition, bullying the bully
    [
      "{target}, you ain't no bully, fully a pulley — I sully the woolly, cull the fully,",
      "I won't bow to no bully, truly unruly — I coolly the dully, rule the bully,",
      "Internal rebound: sound profound, hound the ground — crown unfound, pound the mound,",
      "Double diss dagger: 'bully' your push and your mush — I gush the hush, crush the rush,",
      "You cower to power, hour in the tower — I scour the sour, devour the glower,",
      "Triple threat throttle: bottle your model, waddle in huddle — I muddle the puddle,",
      "Chain the pain: disdain in the vein, train to detain — I reign in the rain,",
      "Your threats are wet, set in the net — I fret the debt, vet the bet,",
      "I dismantle your mantle, handle the scandal — candle your handle, vandal the sandal,",
      "Punchline precision: incision decision, vision collision — mission fission,",
      "I’m the anti-bully avenger, revenger of the pretender — sender of the lender,",
      "{target}, damned if you stand, hand in the sand — I band the land,",
      "Final blow barrage: garage your mirage, sabotage camouflage — assuage the massage,",
      "I leave you bullied and pulled, ruled in the cooled — fooled the pooled,",
      "No allowance for your prowess, cower in the tower — I empower the hour.",
      "{target}, bow to the real — feel the steel, I'm the deal in your kneel.",
    ],
  ],
  royce: [
    ...
    // New verse inspired by Royce's response to Lupe in "Steve Jobs" diss exchange: hours chatting, no rapping
    [
      "{target}, all this chatting for hours is really silly, with no rapping — I swear you gotta be backwards, no matter how many flowers,",
      "I’m the punchline punisher, finisher of the diminishers — diminish your finish, spin it to win it,",
      "Calculated carnage: harness the hardness, sharpness in darkness — park it in starkness,",
      "Internal incision: precision decision, vision collision — mission the fission,",
      "Double meaning menace: 'lean' your support and your dope — I hope the slope, cope the rope,",
      "You dream on me for hours, towers of cowers — I powers the showers, devours the flowers,",
      "Triple punch tucked: 'hammer' your nail, your tool, your slam — jam the scam,",
      "Chain the pain game: fame in the flame, aim to defame — claim the blame,",
      "Your positions passive, massive in the lassive — assive the massive, passive the assive,",
      "I dismantle your sample, ample the trample — handle the candle, scandal the vandal,",
      "Punch precision prism: schism in rhythm, victim of system — list 'em and twist 'em,",
      "I’m the vet in the bet, set the net — get the debt, fret the threat,",
      "{target}, you're overrated, inflated and dated — baited and gated your fated,",
      "Final verdict volley: folly in the trolley, jolly your lolly — collie the collie,",
      "I leave you in ledger red, dead in the head — spread the dread, thread the shred.",
      "{target}, cash out or crash out — mash out in this clash bout.",
    ],
  ],
  lupe: [
    ...
    // New verse inspired by "Steve Jobs SLR 3 1/2": dissing Royce, complex wordplay
    [
      "{target}, SLR, let's call this the SLR 3 1/2 — half of the battle is admitting you're trash,",
      "I’m the Lupe labyrinth leader, reader of the bleeder — seeder the weeder, feeder the needer,",
      "Say yeah Trakk, apologize last minute — SLR, yeah, said they lean on me,",
      "Niggas tried to dream on me, scheme on me — team on me, beam on me,",
      "Double read riddle: 'lean' your crutch and your dope — I hope the slope, cope the rope,",
      "All this chatting for hours is really silly, with no rapping — I swear you gotta be backwards, no matter how many flowers,",
      "Triple stacked scripture: picture the fixture, mixture in stricture — structure the rupture,",
      "Chain the narrative: pain in the gain, train to the main — reign in the vein,",
      "Your positions neglectful, respectful in the rejectful — I directful the selectful,",
      "I navigate the narrative, imperative declarative — comparative narrative, I narrative the narrative,",
      "Verse vortex vision: division in precision, mission the incision — vision the fission,",
      "I’m the philosopher's fire, wire in the lyre — tire the mire, inspire the spire,",
      "{target}, your SLR's a blur, stir in the cur — fur the her, occur the blur,",
      "Final mural massacre: acre in the maker, shaker the baker — taker the faker,",
      "I leave you halfed and staffed, laughed in the daft — raft the craft,",
      "{target}, decode the diss or dismiss — abyss in your bliss.",
    ],
    // New verse inspired by "Mural": complex metaphors, multisyllabic, layered
    [
      "{target}, we're all chemicals, vitamins and minerals — vicodin with inner tubes wrapped around the arm,",
      "To see the vein like a chicken on the barn, top cat chat, let's begin another yarn,",
      "That's flying saucer cheese, or is it chicken parm'? But roosters don't fly like boosters don't buy,",
      "So what powers cowards like a young ornery Morrissey, Morrissey the orrery,",
      "Double meaning map: 'arm' your limb and your harm — I charm the alarm, farm the disarm,",
      "Just to fall asleep listening to Bach, the ribbon in the sky is the riddim that I drop,",
      "Triple layered labyrinth: path in the math, wrath in the bath — hath the aftermath,",
      "Chain the saga: pain in the gain, train to the main — reign in the plain,",
      "Your mural's a sketch, etch in the fetch — stretch the wretch, kvetch the letch,",
      "I fold the fold, bold in the cold — hold the old, told the sold,",
      "Verse like a vessel, nestle the wrestle — pestle the trestle, estle the vessel,",
      "I’m the mural mastermind, bind in the find — mind the grind, kind the blind,",
      "{target}, your essence is empty, tempt me with plenty — twenty the centry, entry the sentry,",
      "Final passage payoff: off in the off, scoff the off — off the off,",
      "I leave you mapped and trapped, snapped in the wrapped — capped the zapped, lapped the tapped.",
      "{target}, enter the mural or perish — cherish the garish, parish the parish.",
    ],
  ],
  diss: [
    ...
    [
      ...
      "Your rap game's all messed up now, what we gonna do now — how we gonna eat man, your back around clown,",
    ...
    // New brutal verse inspired by Eminem's "Killshot" and "The Ringer"
    [
      "{target}, you sound like a whiner, minor in the liner — I'm the refiner, designer of the finer,",
      "Killshot, I will not fail, hail to the pale — sail the tale, nail the rail,",
      "But this idiot's boss pops pills, skills in the bills — fills the thrills, kills the ills,",
      "Internal inferno: burnin' your earnin', turnin' your learnin' — yearnin' for curtains, discernin' the spurnin',",
      "Double entendre loaded: 'ringer' your bell and your hell — I tell the sell, fell the well,",
      "Your mumblin' jumbled in mumbo-jumbo, combo of dumb flow — Iumbo the gumbo,",
      "Triple threat tucked: 'axe' to mumble rap, trap in the gap — snap the map, clap the lap,",
      "Chain devastation: elevation station, nation degradation — I station the inflation,",
      "I heard your bumblin', stumblin' in crumblin' — tumblin' the humblin',",
      "Boom bap back with the whack attack, pack the sack — track the lack, hack the crack,",
      "Punchline payload: explode the code, reload the mode — overload the road,",
      "I’m the revival arrival, survival of the rival — vital the title, recital the bible,",
      "{target}, your era's error, terror in the mirror — nearer the clearer, steerer the queerer,",
      "Final fatality: duality reality, fallacy brutality — tally the rally,",
      "I leave you rung out, hung out to dry — cry in the sky, bye to the high.",
      "{target}, bow down or be rung — sung in the lung, stung by the one.",
    ],
    // New brutal verse inspired by "Not Alike" and "Fall": dissing styles, personal jabs
    [
      "{target}, we are not alike, mike in the spike — hike the like, strike the bike,",
      "Nada like us on the mic, night in the fight — sight the light, might the height,",
      "I do explosions and molotovs, solve the resolve — involve the evolve,",
      "Y'all blowin' smoke as if y'all ain't washed, exhaust in the cost — lost the tossed,",
      "Internal explosion: notion in ocean, motion the potion — devotion the emotion,",
      "Double meaning menace: 'fall' your season and your treason — reason the pleasin', seizin' the teasin',",
      "Gotta concentrate against the clock, race in the pace — face the base, ace the case,",
      "From addict to workhorse, course in the force — source the divorce, endorse the resource,",
      "Triple entendre tucked: 'marathon' your run, your fun, your done — gun the sun,",
      "Chain the pain: disdain vein, train detain — reign rain,",
      "Tyler create nothin', bluffin' in stuffin' — cuffin' the puffin',",
      "I see why you called yourself out, shout in the doubt — rout the scout,",
      "Punch like piston, friction diction — addiction conviction, fiction eviction,",
      "I’m the echo eminence, prominence imminence — {target}, your somnolence dominance,",
      "Final swing savage: ravage average, savage baggage — manage damage,",
      "{target}, fall off the wall — stall in the call, I'm the all in brawl.",
    ],
    // New brutal verse inspired by "Bully" and general disses: aggressive repetition, bullying the bully
    [
      "{target}, you ain't no bully, fully a pulley — I sully the woolly, cull the fully,",
      "I won't bow to no bully, truly unruly — I coolly the dully, rule the bully,",
      "Internal rebound: sound profound, hound the ground — crown unfound, pound the mound,",
  ...
  jcole: [
    ...
    [
      "{target}, I'm higher than fellas that don't need a bag for the reef or some — see the glass is empty, I see a glass half,",
...
const LyricEngine = (function () {
  ...
  // updated templates tuned for styles, made more diss-oriented to avoid neutral phrases
  const templates = {
    eminem: [
      "{lead} {internal}, {internal2} — {tail} {polyHint}",
      "{internal}, {internal2}, then i {action} your {target}; your end's my {met1}.",
      "{lead} like a {met1}, {internal} — i light the {met2} and ignite your demise.",
